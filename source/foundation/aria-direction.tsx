...
export function useAriaDirectionBridge(
  ...
  return useMemo(() => {
    ...
    return event => {
      ...
      if ((target instanceof HTMLInputElement && !directionalInputTypes.has(target.type)) || target instanceof HTMLTextAreaElement || target instanceof HTMLSelectElement || (editable && editable.getAttribute("role") !== "spinbutton")) return
